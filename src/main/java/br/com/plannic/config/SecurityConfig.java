...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable().cors().and().authorizeRequests().antMatchers("/authenticate/**","/forgot/**","/reset-password/**","/usuario/cadastro*","/usuario/verify*", "/materia/cadastro", "/usuario", "/agendamento/cadastro", "/notasMateria/cadastro", "/materia", "/notasMateria", "agendamento", "/materia/{id}", "/notasMateria/{id}", "/usuario/{id}", "/agendamento/{id}", "/usuario/redefinicao","/swagger-ui.html/*","/swagger-ui.html","/swagger-ui.html*", "/notasMateria/notasvstipo/{idusuario}", "/notasMateria/horasvsnota/{idusuario}", "/tutoria/**","/material/**","/notasusuario/**"," / v2 / api-docs " ,
